...
let sbc;
if (
  sessionStorage.getItem("vim") !== null &&
  sessionStorage.getItem("vim") === "95142"
) {
  sbc = true;
}
...
const drawPost = (arrayPost) => {
  ...
  arrayPost.forEach((post, index) => {
    ...
    let divCardbody = createNode("div", null, [
      "card-body",
      "container",
      "pt-2",
    ]);
    ...
    let divInfoUser = createNode("div", null, [
      "row",
    ...
    let avatarCardUserDiv = createNode("div", "", [
      "card",
      "user",
      "flex-md-column",
    ...
    let avatarCardheaderDiv = createNode("div", "", [
      "header",
      "pt-md-2",
      "d-md-flex",
      "flex-md-row",
    ...
    let avatarNombreDivCard = createNode("div", usuario.userName, [
      "name-avatar",
      "pt-md-2",
    ]);
    ...
    let avatarCardp = createNode(
      "p",
      `Lorem iprehenderit aliquid, iustoiis eveniet. Exercitationem fugiat,nesciunt, veritatis optio quo,
    ...
    let divWrappertTitlePost = createNode("div", null, [
      "row",
      "pt-2",
      "ml-md-5",
      "no-gutters",
    ...
    let divWTagsPost = createNode("div", null, [
      "row",
      "pt-2",
      "ml-md-5",
      "no-gutters",
    ...
    tags.forEach((tag) => {
      let divTagsPost = createNode("div", `#${tag}`, [
        "flex-mark",
        "pl-2",
        "pl-md-2",
      ]);
    ...
    let divWInteractions = createNode("div", null, [
      "row",
      "pt-3",
      "ml-md-5",
      "no-gutters",
    ...
    let divTxtReactions = createNode("div", "reactions", [
      "d-none",
      "d-md-block",
      "pl-md-1",
    ]);
    divWheart.appendChild(divTxtReactions);
    let divWComment = createNode("div", null, [
      "comments",
      "d-flex",
      "flex-row",
    ]);
    ...
    let divTxtComment = createNode("div", txtComment, [
      "d-none",
      "d-md-block",
      "pl-md-1",
    ]);
    divWComment.appendChild(divTxtComment);
    let divWInfo = createNode("div", null, [
      "d-flex",
      "flex-row",
      "align-items-center",
    ]);
...
const filterWeek = (arrayPost) => {
  ...
  arrayPost = arrayPost.filter((post) => {
    return (
      Number(post.fechaConvertida[1]) === mes &&
...
const filterMonth = (arrayPost) => {
  ...
  arrayPost = arrayPost.filter(
    (post) => Number(post.fechaConvertida[1]) === new Date().getMonth() + 1
  );
  drawPost(arrayPost);
};
...
const filterYear = (arrayPost) => {
  ...
  arrayPost = arrayPost.filter(
    (post) => Number(post.fechaConvertida[2]) === new Date().getFullYear()
  );
